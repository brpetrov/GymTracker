    ...
    <app-layout>
        ...
        <div class="py-12">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <form  @submit.prevent="updateWorkout" action="/workouts" class="mt-6" id="editWorkoutForm" enctype="multipart/form-data">
    ...
    export default {
        ...
        data(){
            return{
                ...
                imgPreview:`http://localhost:8000/storage/${this.workout.img}`
            }
        },
        methods: {
            updateWorkout(){
                ...
                this.$inertia.post(`/workouts/${this.workout.id}`,data)
            },
            imgSelected(e){
